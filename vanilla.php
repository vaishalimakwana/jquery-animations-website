...
<!--<a href="javascript:parent.jQuery.fancybox.close();">X</a>-->
	<div class="posrelative">
			...
			<div class="FlexBox2">
			<div class="ImgBox">
				<img src="images/vanila_img.png"/>
			</div>	
			<div class="TeamInfoContent">
				<h2 class="InfoHeading">Vanilla</h2>
				<div id="demo" class="custom-scroll custom-scroll-2">Vanilla , highly valued for its flavours worldwide, is even more valued at our clinic. 
A gentle soothing whiff that keeps things clean, pristine and pleasant. (though she keeps moving things, in places where we can never find)
She is there without her making her presence obviously felt. <br><br>
Her evening tea and coffee are flavours without which the day would be like an ice cream without vanilla.
